...
public class AtmSystem {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 2:
                    int depositMoney = readPositiveAmount(sc, "請輸入存款金額：");
                ...
                case 3:
                    int withdrawMoney = readPositiveAmount(sc, "請輸入提款金額：");

                    if (canWithdraw(balance, withdrawMoney)) {
    ...
    public static void printSummary(int balance,
                                    int depositCount,
                                    int withdrawCount,
                                    int totalDeposit,
                                    int totalWithdraw) {
